...
public class KeywordClassDelegatingMetaClass2 extends DelegatingMetaClass {
    private GroovyClassLoader groovyClassLoader;
    KeywordClassDelegatingMetaClass2(final Class<?> clazz, GroovyClassLoader groovyClassLoader) {
        super(clazz);
        initialize();
